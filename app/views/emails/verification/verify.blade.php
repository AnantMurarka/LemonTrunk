							...
							<td class="wrapper vertical-middle">
								...
								<tr>
									<td class="vertical-middle">
										<a href="{{ URL::to('/') }}">
										<img src="{{ URL::to('assets/frontend/layout/img/logos/logo-red.png') }}" width="86" height="14" border="0" alt=""/>
										</a>
									</td>
								</tr>
								</table>
			...
			<td>
				...
				<tr>
					<td class="wrapper">
						...
						<tr>
							<td>
								<h4>Download our iOS and Android App!</h4>
								<p>
									 Need to call the nearest hospital for an emergency and an ambulance service? Use our mobile app!
								</p>
								<ul>
									<li>
										 Free App
